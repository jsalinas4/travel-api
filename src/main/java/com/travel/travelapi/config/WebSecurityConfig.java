...
import com.travel.travelapi.security.JWTFilter;
import com.travel.travelapi.security.JwtAuthenticationEntryPoint;
import com.travel.travelapi.security.TokenProvider;
import com.travel.travelapi.security.JWTConfigurer;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(antMatcher("/article/create")).permitAll()
                        .requestMatchers(antMatcher("/article/list")).permitAll()
